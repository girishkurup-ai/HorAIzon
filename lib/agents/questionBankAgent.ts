...
export async function generateInitialQuestions(
  ...
  const response = await getClient().chat.completions.create({
    ...
    messages: [
      {
        role: 'system',
        content: `You are an expert Question Bank Agent. Generate a comprehensive set of interview questions
...
export async function generateGapQuestions(
  ...
  const response = await getClient().chat.completions.create({
    ...
    messages: [
      {
        role: 'system',
        content: `You are a Question Bank Agent specializing in gap analysis.
